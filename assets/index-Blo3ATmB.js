...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Si,depthTest:!1,depthWrite:!1})}function Yu(){return new Ai({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Dc(),fragmentShader:`
		...
		`,blending:Si,depthTest:!1,depthWrite:!1})}function $u(){return new Ai({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Dc(),fragmentShader:`
	...
	`}function b0(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===xl||l===yl,u=l===Ds||l===Us;if(c||u){let h=e.get(a);const d=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new qu(i)),h=c?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const f=a.image;return c&&f&&f.height>0||u&&f&&s(f)?(t===null&&(t=new qu(i)),h=c?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",r),h.texture):null}}}return a}function s(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function E0(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&vr("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function T0(i,e,t,n){const s={},r=new WeakMap;function o(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let m=0,p=_.length;m<p;m++)e.remove(_[m])}d.removeEventListener("dispose",o),delete s[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(h,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const f=h.morphAttributes;for(const g in f){const _=f[g];for(let m=0,p=_.length;m<p;m++)e.update(_[m],i.ARRAY_BUFFER)}}function c(h){const d=[],f=h.index,g=h.attributes.position;let _=0;if(f!==null){const v=f.array;_=f.version;for(let S=0,x=v.length;S<x;S+=3){const L=v[S+0],A=v[S+1],w=v[S+2];d.push(L,A,A,w,w,L)}}else if(g!==void 0){const v=g.array;_=g.version;for(let S=0,x=v.length/3-1;S<x;S+=3){const L=S+0,A=S+1,w=S+2;d.push(L,A,A,w,w,L)}}else return;const m=new(Sd(d)?Rd:wd)(d,1);m.version=_;const p=r.get(h);p&&e.remove(p),r.set(h,m)}function u(h){const d=r.get(h);if(d){const f=h.index;f!==null&&d.version<f.version&&c(h)}else c(h);return r.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function A0(i,e,t){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function l(d,f){i.drawElements(n,f,r,d*o),t.update(f,n,1)}function c(d,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,d*o,g),t.update(f,n,g))}function u(d,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function h(d,f,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)c(d[p]/o,f[p],_[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,g);let p=0;for(let v=0;v<g;v++)p+=f[v]*_[v];t.update(p,n,1)}}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function w0(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(r/3);break;case i.LINES:t.lines+=a*(r/2);break;case i.LINE_STRIP:t.lines+=a*(r-1);break;case i.LINE_LOOP:t.lines+=a*r;break;case i.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function R0(i,e,t){const n=new WeakMap,s=new Qe;function r(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(a);if(d===void 0||d.count!==h){let E=function(){w.dispose(),n.delete(a),a.removeEventListener("dispose",E)};d!==void 0&&d.texture.dispose();const f=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,_=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],v=a.morphAttributes.color||[];let S=0;f===!0&&(S=1),g===!0&&(S=2),_===!0&&(S=3);let x=a.attributes.position.count*S,L=1;x>e.maxTextureSize&&(L=Math.ceil(x/e.maxTextureSize),x=e.maxTextureSize);const A=new Float32Array(x*L*4*h),w=new Ed(A,x,L,h);w.type=Sn,w.needsUpdate=!0;const C=S*4;for(let M=0;M<h;M++){const I=m[M],H=p[M],z=v[M],W=x*L*4*M;for(let K=0;K<I.count;K++){const X=K*C;f===!0&&(s.fromBufferAttribute(I,K),A[W+X+0]=s.x,A[W+X+1]=s.y,A[W+X+2]=s.z,A[W+X+3]=0),g===!0&&(s.fromBufferAttribute(H,K),A[W+X+4]=s.x,A[W+X+5]=s.y,A[W+X+6]=s.z,A[W+X+7]=0),_===!0&&(s.fromBufferAttribute(z,K),A[W+X+8]=s.x,A[W+X+9]=s.y,A[W+X+10]=s.z,A[W+X+11]=z.itemSize===4?s.w:1)}}d={count:h,texture:w,size:new Be(x,L)},n.set(a,d),a.addEventListener("dispose",E)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let f=0;for(let _=0;_<c.length;_++)f+=c[_];const g=a.morphTargetsRelative?1:1-f;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function C0(i,e,t,n){let s=new WeakMap;function r(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(s.get(h)!==c&&(e.update(h),s.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;s.get(d)!==c&&(d.update(),s.set(d,c))}return h}function o(){s=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:o}}class Dd extends Tt{constructor(e,t,n,s,r,o,a,l,c,u=Es){if(u!==Es&&u!==Os)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Es&&(n=Xi),n===void 0&&u===Os&&(n=Fs),super(null,s,r,o,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Ht,this.minFilter=l!==void 0?l:Ht,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const Ud=new Tt,Ku=new Dd(1,1),Nd=new Ed,Fd=new mm,Od=new Ld,Zu=[],Ju=[],Qu=new Float32Array(16),eh=new Float32Array(9),th=new Float32Array(4);function qs(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=Zu[s];if(r===void 0&&(r=new Float32Array(s),Zu[s]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(r,a)}return r}function Mt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function St(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function aa(i,e){let t=Ju[e];t===void 0&&(t=new Int32Array(e),Ju[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function I0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function L0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Mt(t,e))return;i.uniform2fv(this.addr,e),St(t,e)}}function P0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Mt(t,e))return;i.uniform3fv(this.addr,e),St(t,e)}}function D0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Mt(t,e))return;i.uniform4fv(this.addr,e),St(t,e)}}function U0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Mt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),St(t,e)}else{if(Mt(t,n))return;th.set(n),i.uniformMatrix2fv(this.addr,!1,th),St(t,n)}}function N0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Mt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),St(t,e)}else{if(Mt(t,n))return;eh.set(n),i.uniformMatrix3fv(this.addr,!1,eh),St(t,n)}}function F0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Mt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),St(t,e)}else{if(Mt(t,n))return;Qu.set(n),i.uniformMatrix4fv(this.addr,!1,Qu),St(t,n)}}function O0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function B0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Mt(t,e))return;i.uniform2iv(this.addr,e),St(t,e)}}function k0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Mt(t,e))return;i.uniform3iv(this.addr,e),St(t,e)}}function z0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Mt(t,e))return;i.uniform4iv(this.addr,e),St(t,e)}}function H0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function G0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Mt(t,e))return;i.uniform2uiv(this.addr,e),St(t,e)}}function V0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Mt(t,e))return;i.uniform3uiv(this.addr,e),St(t,e)}}function W0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Mt(t,e))return;i.uniform4uiv(this.addr,e),St(t,e)}}function X0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Ku.compareFunction=Md,r=Ku):r=Ud,t.setTexture2D(e||r,s)}function q0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Fd,s)}function j0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||Od,s)}function Y0(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||Nd,s)}function $0(i){switch(i){case 5126:return I0;case 35664:return L0;case 35665:return P0;case 35666:return D0;case 35674:return U0;case 35675:return N0;case 35676:return F0;case 5124:case 35670:return O0;case 35667:case 35671:return B0;case 35668:case 35672:return k0;case 35669:case 35673:return z0;case 5125:return H0;case 36294:return G0;case 36295:return V0;case 36296:return W0;case 35678:case 36198:case 36298:case 36306:case 35682:return X0;case 35679:case 36299:case 36307:return q0;case 35680:case 36300:case 36308:case 36293:return j0;case 36289:case 36303:case 36311:case 36292:return Y0}}function K0(i,e){i.uniform1fv(this.addr,e)}function Z0(i,e){const t=qs(e,this.size,2);i.uniform2fv(this.addr,t)}function J0(i,e){const t=qs(e,this.size,3);i.uniform3fv(this.addr,t)}function Q0(i,e){const t=qs(e,this.size,4);i.uniform4fv(this.addr,t)}function ev(i,e){const t=qs(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function tv(i,e){const t=qs(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function nv(i,e){const t=qs(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function iv(i,e){i.uniform1iv(this.addr,e)}function sv(i,e){i.uniform2iv(this.addr,e)}function rv(i,e){i.uniform3iv(this.addr,e)}function ov(i,e){i.uniform4iv(this.addr,e)}function av(i,e){i.uniform1uiv(this.addr,e)}function lv(i,e){i.uniform2uiv(this.addr,e)}function cv(i,e){i.uniform3uiv(this.addr,e)}function uv(i,e){i.uniform4uiv(this.addr,e)}function hv(i,e,t){const n=this.cache,s=e.length,r=aa(t,s);Mt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let o=0;o!==s;++o)t.setTexture2D(e[o]||Ud,r[o])}function dv(i,e,t){const n=this.cache,s=e.length,r=aa(t,s);Mt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||Fd,r[o])}function fv(i,e,t){const n=this.cache,s=e.length,r=aa(t,s);Mt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||Od,r[o])}function pv(i,e,t){const n=this.cache,s=e.length,r=aa(t,s);Mt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||Nd,r[o])}function mv(i){switch(i){case 5126:return K0;case 35664:return Z0;case 35665:return J0;case 35666:return Q0;case 35674:return ev;case 35675:return tv;case 35676:return nv;case 5124:case 35670:return iv;case 35667:case 35671:return sv;case 35668:case 35672:return rv;case 35669:case 35673:return ov;case 5125:return av;case 36294:return lv;case 36295:return cv;case 36296:return uv;case 35678:case 36198:case 36298:case 36306:case 35682:return hv;case 35679:case 36299:case 36307:return dv;case 35680:case 36300:case 36308:case 36293:return fv;case 36289:case 36303:case 36311:case 36292:return pv}}class gv{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=$0(t.type)}}class _v{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=mv(t.type)}}class vv{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,t[a.id],n)}}}const qa=/(\w+)(\])?(\[|\.)?/g;function nh(i,e){i.seq.push(e),i.map[e.id]=e}function xv(i,e,t){const n=i.name,s=n.length;for(qa.lastIndex=0;;){const r=qa.exec(n),o=qa.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){nh(t,c===void 0?new gv(a,i,e):new _v(a,i,e));break}else{let h=t.map[a];h===void 0&&(h=new vv(a),nh(t,h)),t=h}}}class Fo{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),o=e.getUniformLocation(t,r.name);xv(r,o,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,o=t.length;r!==o;++r){const a=t[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in t&&n.push(o)}return n}}function ih(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const yv=37297;let Mv=0;function Sv(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const sh=new Ue;function bv(i){We._getMatrix(sh,We.workingColorSpace,i);const e=`mat3( ${sh.elements.map(t=>t.toFixed(4))} )`;switch(We.getTransfer(i)){case ia:return[e,"LinearTransferOETF"];case at:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function rh(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+Sv(i.getShaderSource(e),o)}else return s}function Ev(i,e){const t=bv(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Tv(i,e){let t;switch(e){case Mp:t="Linear";break;case Sp:t="Reinhard";break;case bp:t="Cineon";break;case Ep:t="ACESFilmic";break;case Ap:t="AgX";break;case wp:t="Neutral";break;case Tp:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const _o=new R;function Av(){We.getLuminanceCoefficients(_o);const i=_o.x.toFixed(4),e=_o.y.toFixed(4),t=_o.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function wv(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(xr).join(`
`)}function Rv(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Cv(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function xr(i){return i!==""}function oh(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function ah(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Iv=/^[ \t]*#include +<([\w\d./]+)>/gm;function $l(i){return i.replace(Iv,Pv)}const Lv=new Map;function Pv(i,e){let t=ze[e];if(t===void 0){const n=Lv.get(e);if(n!==void 0)t=ze[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return $l(t)}const Dv=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function lh(i){return i.replace(Dv,Uv)}function Uv(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function ch(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function Nv(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===ld?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===ep?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===qn&&(e="SHADOWMAP_TYPE_VSM"),e}function Fv(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ds:case Us:e="ENVMAP_TYPE_CUBE";break;case na:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Ov(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Us:e="ENVMAP_MODE_REFRACTION";break}return e}function Bv(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Mc:e="ENVMAP_BLENDING_MULTIPLY";break;case xp:e="ENVMAP_BLENDING_MIX";break;case yp:e="ENVMAP_BLENDING_ADD";break}return e}function kv(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function zv(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Nv(t),c=Fv(t),u=Ov(t),h=Bv(t),d=kv(t),f=wv(t),g=Rv(r),_=s.createProgram();let m,p,v=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
    ...
    <div class="perf-overlay"></div>`,Ze.vignette=yt.querySelector(".vignette"),Ze.hpBar=yt.querySelector(".bar.hp"),Ze.hpFill=yt.querySelector(".bar.hp .bar-fill"),Ze.hpGhost=yt.querySelector(".bar.hp .bar-ghost"),Ze.hpText=yt.querySelector(".bar.hp .bar-text"),Ze.xpTop=yt.querySelector(".xp-top"),Ze.xpFill=yt.querySelector(".xp-top-fill"),Ze.level=yt.querySelector(".level-badge"),Ze.timer=yt.querySelector(".hud-timer"),Ze.banner=yt.querySelector(".climax-banner"),Ze.embers=yt.querySelector(".stat.embers .stat-val"),Ze.kills=yt.querySelector(".stat.kills .stat-val"),Te.on("run-start",()=>{Rr=0,_i=1,ms=1,br=0,yt.classList.add("visible"),yt.classList.remove("climax"),Ze.banner.classList.remove("show")}),Te.on("game-over",()=>{yt.classList.remove("visible","climax")}),Te.on("player-hit",()=>{Rr=1}),Ze.perf=yt.querySelector(".perf-overlay"),window.addEventListener("keydown",i=>{i.code==="F3"&&(i.preventDefault(),Go=!Go,Ze.perf.classList.toggle("show",Go))}),Te.on("climax-start",({label:i})=>{yt.classList.add("climax"),Ze.banner.textContent=i,Ze.banner.classList.add("show"),setTimeout(()=>Ze.banner.classList.remove("show"),4e3)})}function YS(i){if(!yt)return;if(Go&&(al+=i,al>=.5)){al=0;const h=window.__perf??{frames:0,workMs:0},d=performance.now(),f=h.frames-Ro.frames,g=h.workMs-Ro.workMs,_=(d-Ro.t)/1e3,m=_>0?Math.round(f/_):0,p=f>0?(g/f).toFixed(2):"—";Ro={frames:h.frames,workMs:h.workMs,t:d};const v=si.info;Ze.perf.textContent=`${m} fps · ${p} ms cpu
${v.render.calls} draws · ${(v.render.triangles/1e3).toFixed(0)}k tris
${$i().length} enemies · dpr ${si.getPixelRatio()}
v${ye.version}`}Rr=Math.max(0,Rr-i*2.2);const e=F.player.maxHp>0?F.player.hp/F.player.maxHp:0,t=e<.35?(.35-e)/.35*.45:0;Ze.vignette.style.opacity=Math.min(1,Rr*.9+t).toFixed(3);const n=Math.max(0,Math.min(1,e));Ze.hpFill.style.width=`${n*100}%`,n<ms-.001?(wo=.35,_i<ms&&(_i=ms)):n>ms+.001&&(br=.4,_i=n),ms=n,wo=Math.max(0,wo-i),wo<=0&&_i>n&&(_i=Math.max(n,_i-i*.6)),Ze.hpGhost.style.width=`${_i*100}%`,br=Math.max(0,br-i),Ze.hpBar.classList.toggle("heal",br>0),Ze.hpBar.classList.toggle("low",n<.35&&F.running);const s=`${Math.max(0,Math.ceil(F.player.hp))} / ${Math.round(F.player.maxHp)}`;s!==nn.hpText&&(nn.hpText=s,Ze.hpText.textContent=s);const r=F.xpNext>0?F.xp/F.xpNext:0;Ze.xpFill.style.width=`${Math.max(0,Math.min(1,r))*100}%`,Ze.xpTop.classList.toggle("near",r>.85),F.level!==nn.level&&(nn.level=F.level,Ze.level.textContent=`Lvl ${F.level}`);const o=Number.isFinite(ye.run.duration)?Math.max(0,ye.run.duration-F.time):F.time,a=Math.floor(o/60),l=Math.floor(o%60),c=`${a}:${String(l).padStart(2,"0")}`;c!==nn.timer&&(nn.timer=c,Ze.timer.textContent=c);const u=Number.isFinite(ye.run.duration)&&o<=30&&F.running;u!==nn.urgent&&(nn.urgent=u,Ze.timer.classList.toggle("urgent",u)),F.gold!==nn.embers&&(nn.embers=F.gold,Ze.embers.textContent=F.gold),F.kills!==nn.kills&&(nn.kills=F.kills,Ze.kills.textContent=F.kills)}const $S=Object.freeze(Object.defineProperty({__proto__:null,init:jS,update:YS},Symbol.toStringTag,{value:"Module"}));let Is=null,pc=[],mc=[];const Rt=i=>Te.emit("sfx",{name:i}),nd=fe.spinIcons,Ie=fe.strings;function Vo(i,e){pc.push(setTimeout(i,e))}function id(i,e){const t=setInterval(i,e);return mc.push(t),t}function Gf(){for(const i of pc)clearTimeout(i);for(const i of mc)clearInterval(i);pc=[],mc=[]}function ne(i,e,t){const n=document.createElement(i);return e&&(n.className=e),t!=null&&(n.textContent=t),n}function Yr(i){Gf(),Is.innerHTML="";const e=ne("div",`modal ${i||""}`.trim());return Is.appendChild(e),Is.classList.add("active"),e}function va(){Gf(),Is.classList.remove("active"),Is.innerHTML=""}function sd(i,e){i.classList.remove("shake-1","shake-2","shake-3"),i.offsetWidth,i.classList.add(`shake-${Math.max(1,Math.min(3,e))}`)}function KS(){Is=document.getElementById("overlay"),Te.on("levelup-choices",QS),Te.on("chest-opened",eb),Te.on("game-over",Xf),JS()}function ZS(i){}function Vf(){const i=ne("div","jobs-wrap");i.appendChild(ne("div","jobs-label",Ie.crewLabel));const e=ne("div","crew-row"),t=ne("p","job-blurb"),n=ne("div","crew-balance"),s=()=>{e.innerHTML="";const r=Ws();for(const a of Or){const l=ua(a.id)||!a.cost,c=ne("button",`crew-chip${l?"":" locked"}${r.id===a.id?" selected":""}`,l?a.name:`${a.name} · ${a.cost} ${Ie.currencyIcon}`);c.addEventListener("click",()=>{l?(uf(a.id),Rt("click")):hf(a.id,a.cost)?Rt("buy"):Rt("hit"),s()}),e.appendChild(c)}const o=Ws();t.textContent=`${o.name} — ${o.desc}`,n.textContent=Ie.shopBalance(Zo())};return s(),i.append(e,t,n),i}function Wf(){if(Ei.length<=1)return null;const i=ne("div","jobs-wrap");i.appendChild(ne("div","jobs-label",Ie.contractsLabel));const e=ne("div","jobs-row"),t=ne("p","job-blurb"),n=()=>{e.innerHTML="",Ei.forEach((r,o)=>{const a=o<Nr(),l=o>Nr(),c=ne("button",`job-chip${a?" done":""}${l?" locked":""}${o===ri?" selected":""}`,a?Ie.sealIcon:String(o+1));c.title=l?Ie.lockedLabel:r.name,c.disabled=l,c.addEventListener("click",()=>{Rt("click"),eu(o),n()}),e.appendChild(c)});const s=Ei[ri];t.textContent=`${s.name} — ${s.blurb}${(s.payMult??1)>1?` · pays ×${s.payMult}`:""}`};if(n(),i.append(e,t),Jc()){const s=ne("label","endless-toggle"),r=ne("input");r.type="checkbox",r.checked=Ti,r.addEventListener("change",()=>{Rt("click"),mf(r.checked)}),s.appendChild(r),s.appendChild(ne("span",null,Ie.endlessLabel)),i.appendChild(s)}return i}function JS(){const i=Yr("start");i.appendChild(ne("div","sigil-mark",Ie.startMark)),i.appendChild(ne("h1",null,Ie.startTitle)),i.appendChild(ne("p","sub",Ie.startTagline));const e=ne("div","contract-paper");for(const c of Ie.contractClauses){const u=ne("p");u.append(ne("span","clause-no",c.lead),document.createTextNode(c.text)),e.appendChild(u)}e.appendChild(ne("span","signature",Ie.signature)),i.appendChild(e);const t=ne("button","btn btn-blood",Ie.signButton);t.addEventListener("click",()=>{Rt("click"),va(),Te.emit("restart-run",{})}),i.appendChild(t);const n="ontouchstart"in window||navigator.maxTouchPoints>0;i.appendChild(ne("p","hint",n?Ie.hintTouch:Ie.hint)),Or.length>1&&i.appendChild(Vf());const s=Wf();s&&i.appendChild(s);const r=ne("div","theme-row");r.appendChild(ne("span","theme-label",Ie.gfxLabel));const o=ne("div","crew-row"),a=()=>{o.innerHTML="";for(const c of Object.keys(Xs)){const u=ne("button",`crew-chip${nS()===c?" selected":""}`,Xs[c].label);u.addEventListener("click",()=>{Rt("click"),sS(c),a()}),o.appendChild(u)}};a(),r.appendChild(o),i.appendChild(r);const l=QM();if(l>0){const c=ne("button","telemetry-btn",`⇣ playtest data · ${l} run${l===1?"":"s"}`);c.title="Download your local run stats as JSON (nothing is sent automatically)",c.addEventListener("click",()=>{Rt("click"),eS()}),i.appendChild(c)}}function QS({choices:i,onPick:e}){const t=Yr("levelup");t.appendChild(ne("h2",null,Ie.levelupTitle)),t.appendChild(ne("p","sub",Ie.levelupSub));const n=ne("div","cards");for(const s of i){const r=ne("div","card");r.appendChild(ne("div","card-icon",s.icon)),r.appendChild(ne("div","card-name",s.name)),r.appendChild(ne("div","card-desc",s.desc)),r.addEventListener("click",()=>{Rt("click"),va(),e(s)}),n.appendChild(r)}t.appendChild(n)}function eb({rewards:i,gold:e,onDone:t}){const n=Yr("chest-modal"),s=i.length,r=s>=5?2:s>=3?1:0;n.appendChild(ne("h2",null,Ie.chestTitle)),n.appendChild(ne("p","sub",r===2?Ie.chestSub[5]:r===1?Ie.chestSub[3]:Ie.chestSub[1]));const o=r?n.appendChild(ne("div","jackpot-banner",r===2?Ie.jackpotBanner[5]:Ie.jackpotBanner[3])):null;o&&(o.style.visibility="hidden");const a=ne("div","slots"),l=i.map(_=>{const m=ne("div","slot");return m.appendChild(ne("div","slot-icon","?")),m.appendChild(ne("div","slot-name",_.name)),a.appendChild(m),m});n.appendChild(a);const c=ne("div","gold-line",Ie.goldLabel),u=ne("span","gold-count","0");c.appendChild(u),n.appendChild(c);const h=ne("button","btn",Ie.collectButton);h.disabled=!0,h.addEventListener("click",()=>{h.disabled||(Rt("click"),va(),t())}),n.appendChild(h),Rt("jingle");const d=600,f=260;i.forEach((_,m)=>{const p=l[m],v=p.querySelector(".slot-icon"),S=350+m*(d+f);Vo(()=>{p.classList.add("spinning");const x=id(()=>{v.textContent=nd[Math.random()*nd.length|0]},55);Vo(()=>{clearInterval(x),p.classList.remove("spinning"),p.classList.add("landed"),v.textContent=_.icon,Rt("chest"),sd(n,1+r*(m>=s-2?1:0)+(m===s-1&&r===2?1:0)),m===s-1&&(r===1&&n.classList.add("jackpot"),r===2&&n.classList.add("jackpot","jackpot-big"),o&&(o.style.visibility="visible"))},d)},S)});const g=350+s*(d+f);Vo(()=>{u.classList.add("ticking");const _=70,m=Math.min(1600,Math.max(700,e*45)),p=Math.max(1,Math.round(m/_));let v=0;const S=id(()=>{v++;const x=v/p,L=1-(1-x)*(1-x);u.textContent=String(Math.round(e*Math.min(1,L))),v%2===1&&Rt("coin"),v>=p&&(clearInterval(S),u.textContent=String(e),u.classList.remove("ticking"),sd(n,1+r),h.disabled=!1,h.classList.add("ready"))},_)},g+250)}function Xf(i){if(i.finale&&!i._creditsShown){tb(i);return}const{victory:e,embers:t,kills:n,time:s,level:r}=i,o=Yr("gameover"),a=ne("h1",e?"":"defeat",e?Ie.victoryTitle:Ie.defeatTitle);o.appendChild(a),o.appendChild(ne("p","sub",e?Ie.victorySub:Ie.defeatSub));const l=ne("div","stats-row"),c=Math.floor(s/60),u=Math.floor(s%60),h=[[Ie.statKills,String(n)],[Ie.statTime,`${c}:${String(u).padStart(2,"0")}`],[Ie.statLevel,String(r)]];for(const[_,m]of h){const p=ne("div","stat-block");p.appendChild(ne("span","stat-label",_)),p.appendChild(ne("span","stat-value",m)),l.appendChild(p)}o.appendChild(l),o.appendChild(ne("div","embers-banked",Ie.banked(t)));for(const _ of i.earnedPosters??[])o.appendChild(ne("div","poster-claimed",Ie.posterClaimed(_.name,_.bounty)));o.appendChild(ne("hr","rule"));const d=ne("div","shop");if(o.appendChild(d),qf(d),uc.length){const _=ne("div","poster-wall");_.appendChild(ne("h3",null,Ie.postersTitle));for(const m of uc){const p=Zc(m.id),v=ne("div",`poster-row${p?" got":""}`);v.appendChild(ne("span","poster-name",m.name)),v.appendChild(ne("span","poster-desc",m.desc)),v.appendChild(ne("span","poster-bounty",p?"✓":`+${m.bounty} ${Ie.currencyIcon}`)),_.appendChild(v)}o.appendChild(_)}i.finale&&o.appendChild(ne("div","endless-note",Ie.endlessUnlockedNote)),Or.length>1&&o.appendChild(Vf());const f=Wf();f&&o.appendChild(f);const g=ne("button","btn btn-blood",Ie.newRunButton);g.addEventListener("click",()=>{Rt("click"),va(),Te.emit("restart-run",{})}),o.appendChild(g)}function tb(i){const e=Yr("credits");e.appendChild(ne("h1",null,Ie.creditsTitle));const t=ne("div","credits-roll");Ie.creditsLines.forEach((s,r)=>{const o=ne("p","credits-line",s);o.style.animationDelay=`${.6+r*.9}s`,t.appendChild(o)}),e.appendChild(t),Rt("victory");const n=ne("button","btn",Ie.creditsButton);n.addEventListener("click",()=>{Rt("click"),Xf({...i,_creditsShown:!0})}),Vo(()=>e.appendChild(n),1200)}function qf(i){i.innerHTML="";const e=ne("div","shop-head");e.appendChild(ne("h3",null,Ie.shopTitle)),e.appendChild(ne("span","shop-embers",Ie.shopBalance(Zo()))),i.appendChild(e);const t=ne("div","pact-list"),n=Zo();for(const[s,r]of Object.entries(Ri)){const o=Js(s),a=o>=r.maxLevel,l=Qc(s),c=ne("div","pact-row");c.appendChild(ne("div","pact-icon",r.icon));const u=ne("div","pact-info");u.appendChild(ne("div","pact-name",r.name)),u.appendChild(ne("div","pact-effect",r.effect)),c.appendChild(u);const h=ne("div","pact-pips");for(let f=0;f<r.maxLevel;f++)h.appendChild(ne("span",f<o?"pip":"pip-empty","⬥"));c.appendChild(h);const d=ne("button",`btn pact-buy${a?" sealed":""}`,a?Ie.maxedLabel:Ie.buyLabel(l));d.disabled=a||n<l,d.addEventListener("click",()=>{ff(s)&&(Rt("buy"),qf(i))}),c.appendChild(d),t.appendChild(c)}i.appendChild(t)}const nb=Object.freeze(Object.defineProperty({__proto__:null,init:KS,update:ZS},Symbol.toStringTag,{value:"Module"}));let wt=null,Ls=null,Co=null,kt=null,gc=!1;const rd={},ib=45;let ll=0,od=-1e9;function sb(){window.addEventListener("pointerdown",rb,{passive:!0}),Te.on("sfx",e=>gr(e&&e.name)),Te.on("level-up",()=>gr("levelup")),Te.on("enemy-killed",()=>gr("kill")),Te.on("gold-gained",()=>gr("coin")),Te.on("player-hit",()=>gr("hit"));const i=fe.assets?.audio?.music?.run;i&&(kt=new Audio(typeof i=="string"?i:i.url),kt.loop=!0,kt.volume=typeof i=="object"&&i.volume||.35,kt.preload="auto",Te.on("run-start",()=>{gc=!0,kt.currentTime=0,kt.play().catch(()=>{})}),Te.on("game-over",()=>{gc=!1;const e=kt.volume,t=setInterval(()=>{kt.volume=Math.max(0,kt.volume-e/10),kt.volume<=.01&&(clearInterval(t),kt.pause(),kt.volume=e)},60)}))}function rb(){try{if(!wt){const i=window.AudioContext||window.webkitAudioContext;if(!i)return;wt=new i,Ls=wt.createGain(),Ls.gain.value=.25,Ls.connect(wt.destination)}wt.state==="suspended"&&wt.resume(),kt&&gc&&kt.paused&&kt.play().catch(()=>{})}catch{}}function gr(i){if(!wt||!Ls||!ad[i])return;const e=performance.now();if(!(e-(rd[i]||-1e9)<ib)){rd[i]=e;try{ad[i]()}catch{}}}function ot({f:i=440,f2:e=0,type:t="sine",at:n=0,dur:s=.15,vol:r=.3,attack:o=.008}){const a=wt.currentTime+n,l=wt.createOscillator(),c=wt.createGain();l.type=t,l.frequency.setValueAtTime(i,a),e>0&&l.frequency.exponentialRampToValueAtTime(e,a+s),c.gain.setValueAtTime(1e-4,a),c.gain.linearRampToValueAtTime(r,a+o),c.gain.exponentialRampToValueAtTime(1e-4,a+s),l.connect(c),c.connect(Ls),l.start(a),l.stop(a+s+.03)}function cl({at:i=0,dur:e=.12,vol:t=.3,freq:n=900,q:s=1,type:r="bandpass"}){if(!Co){Co=wt.createBuffer(1,wt.sampleRate*.5,wt.sampleRate);const u=Co.getChannelData(0);for(let h=0;h<u.length;h++)u[h]=Math.random()*2-1}const o=wt.currentTime+i,a=wt.createBufferSource();a.buffer=Co,a.loop=!0;const l=wt.createBiquadFilter();l.type=r,l.frequency.setValueAtTime(n,o),l.Q.value=s;const c=wt.createGain();c.gain.setValueAtTime(1e-4,o),c.gain.linearRampToValueAtTime(t,o+.005),c.gain.exponentialRampToValueAtTime(1e-4,o+e),a.connect(l),l.connect(c),c.connect(Ls),a.start(o),a.stop(o+e+.03)}const ad={shoot(){ot({f:660,f2:160,type:"sawtooth",dur:.07,vol:.12})},hit(){ot({f:140,f2:55,type:"square",dur:.16,vol:.3}),cl({dur:.1,vol:.22,freq:350,type:"lowpass"})},kill(){ot({f:330,f2:90,type:"square",dur:.09,vol:.16}),cl({dur:.05,vol:.1,freq:1800,q:2})},pickup(){ot({f:780,f2:1240,type:"sine",dur:.08,vol:.14})},coin(){const i=performance.now();ll=i-od<300?Math.min(ll+1,14):0,od=i;const e=988*Math.pow(2,ll/12);ot({f:e,type:"triangle",dur:.11,vol:.2}),ot({f:e*1.5,type:"sine",dur:.09,vol:.1,at:.012})},levelup(){ot({f:392,type:"triangle",dur:.22,vol:.22}),ot({f:494,type:"triangle",dur:.22,vol:.22,at:.1}),ot({f:587,type:"triangle",dur:.34,vol:.24,at:.2}),ot({f:784,type:"sine",dur:.4,vol:.14,at:.2})},chest(){ot({f:196,type:"triangle",dur:.3,vol:.2}),ot({f:294,type:"triangle",dur:.3,vol:.16,at:.01}),ot({f:392,type:"sine",dur:.34,vol:.14,at:.02})},jingle(){const i=[523,659,784,1046,1318];i.forEach((e,t)=>{ot({f:e,type:"triangle",dur:.18,vol:.2,at:t*.075}),ot({f:e*2,type:"sine",dur:.14,vol:.06,at:t*.075})}),ot({f:1568,type:"sine",dur:.45,vol:.12,at:i.length*.075}),ot({f:2093,type:"sine",dur:.5,vol:.08,at:i.length*.075+.03})},death(){ot({f:220,f2:38,type:"sawtooth",dur:.9,vol:.26}),ot({f:110,f2:30,type:"triangle",dur:1.1,vol:.22,at:.05}),cl({dur:.7,vol:.12,freq:200,type:"lowpass"})},victory(){const i=[[392,0],[523,.14],[659,.28],[784,.42]];for(const[e,t]of i)ot({f:e,type:"triangle",dur:.26,vol:.22,at:t}),ot({f:e/2,type:"sine",dur:.26,vol:.1,at:t});ot({f:1046,type:"triangle",dur:.7,vol:.24,at:.56}),ot({f:784,type:"sine",dur:.7,vol:.12,at:.56}),ot({f:1318,type:"sine",dur:.6,vol:.08,at:.62})},buy(){ot({f:190,type:"square",dur:.05,vol:.16}),ot({f:1175,type:"triangle",dur:.14,vol:.18,at:.06}),ot({f:1760,type:"sine",dur:.18,vol:.1,at:.09})},click(){ot({f:1100,f2:700,type:"square",dur:.035,vol:.1})}};await Ky(fe);const ou=[pM,EM,fS,qS,ES,$M,PS,BS],jf=[$S,nb];uy();rS();of();JM();aM();eu(Math.min(Nr(),Ei.length-1));sb();for(const i of ou)i.init(On);for(const i of jf)i.init();function ob(){dy(),gf(),lM(F),pf(F);for(const i of ou)i.reset();F.running=!0,Te.emit("run-start",{})}Te.on("restart-run",ob);let _c=!1;Te.on("run-start",()=>{_c=!1});function au(i){if(_c)return;_c=!0,F.running=!1;const e=F.kills*.03*F.mods.greed,t=Fr().payMult??1,n=Math.round((F.gold+e)*(i?1.5:1)*t);af(n);const s=i&&tc()&&!Ti;i&&!Ti&&df(ri,tc());const r=tS({victory:i,job:ri+1,endless:Ti,time:F.time,level:F.level,kills:F.kills,goldRun:F.gold,embersBanked:n,...F.runFlags});Te.emit("game-over",{victory:i,finale:s,embers:n,kills:F.kills,time:F.time,level:F.level,earnedPosters:r})}Te.on("player-died",()=>au(!1));Te.on("climax-victory",()=>au(!0));window.__mephisto={state:F,bus:Te,config:ye,contracts:sM,meta:iM,renderer:si};const vc={last:performance.now()},xc={frames:0,workMs:0};window.__perf=xc;function Yf(i){requestAnimationFrame(Yf);const e=i-vc.last;if(e<iS())return;let t=Math.min(e/1e3,.05);vc.last=i;const n=performance.now();if(F.running&&!F.paused){F.time+=t,F.time>=ye.run.duration&&!Hf()&&au(!0);for(const s of ou)s.update(t)}for(const s of jf)s.update(t);hy(F.player.pos),si.render(On,Mn),xc.frames++,xc.workMs+=performance.now()-n}requestAnimationFrame(i=>{vc.last=i,Yf(i)});
