...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:bi,depthTest:!1,depthWrite:!1})}function sh(){return new Ai({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Vc(),fragmentShader:`
		...
		`,blending:bi,depthTest:!1,depthWrite:!1})}function rh(){return new Ai({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Vc(),fragmentShader:`
	...
	`}function F0(i){let e=new WeakMap,t=null;function n(a){if(a&&a.isTexture){const l=a.mapping,c=l===Tl||l===Al,u=l===Ns||l===Us;if(c||u){let h=e.get(a);const d=h!==void 0?h.texture.pmremVersion:0;if(a.isRenderTargetTexture&&a.pmremVersion!==d)return t===null&&(t=new nh(i)),h=c?t.fromEquirectangular(a,h):t.fromCubemap(a,h),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),h.texture;if(h!==void 0)return h.texture;{const f=a.image;return c&&f&&f.height>0||u&&f&&s(f)?(t===null&&(t=new nh(i)),h=c?t.fromEquirectangular(a):t.fromCubemap(a),h.texture.pmremVersion=a.pmremVersion,e.set(a,h),a.addEventListener("dispose",r),h.texture):null}}}return a}function s(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function r(a){const l=a.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:o}}function O0(i){const e={};function t(n){if(e[n]!==void 0)return e[n];let s;switch(n){case"WEBGL_depth_texture":s=i.getExtension("WEBGL_depth_texture")||i.getExtension("MOZ_WEBGL_depth_texture")||i.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":s=i.getExtension("EXT_texture_filter_anisotropic")||i.getExtension("MOZ_EXT_texture_filter_anisotropic")||i.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":s=i.getExtension("WEBGL_compressed_texture_s3tc")||i.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":s=i.getExtension("WEBGL_compressed_texture_pvrtc")||i.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:s=i.getExtension(n)}return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&yr("THREE.WebGLRenderer: "+n+" extension not supported."),s}}}function B0(i,e,t,n){const s={},r=new WeakMap;function o(h){const d=h.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);for(const g in d.morphAttributes){const _=d.morphAttributes[g];for(let m=0,p=_.length;m<p;m++)e.remove(_[m])}d.removeEventListener("dispose",o),delete s[d.id];const f=r.get(d);f&&(e.remove(f),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function a(h,d){return s[d.id]===!0||(d.addEventListener("dispose",o),s[d.id]=!0,t.memory.geometries++),d}function l(h){const d=h.attributes;for(const g in d)e.update(d[g],i.ARRAY_BUFFER);const f=h.morphAttributes;for(const g in f){const _=f[g];for(let m=0,p=_.length;m<p;m++)e.update(_[m],i.ARRAY_BUFFER)}}function c(h){const d=[],f=h.index,g=h.attributes.position;let _=0;if(f!==null){const x=f.array;_=f.version;for(let S=0,v=x.length;S<v;S+=3){const L=x[S+0],A=x[S+1],w=x[S+2];d.push(L,A,A,w,w,L)}}else if(g!==void 0){const x=g.array;_=g.version;for(let S=0,v=x.length/3-1;S<v;S+=3){const L=S+0,A=S+1,w=S+2;d.push(L,A,A,w,w,L)}}else return;const m=new(Nd(d)?zd:kd)(d,1);m.version=_;const p=r.get(h);p&&e.remove(p),r.set(h,m)}function u(h){const d=r.get(h);if(d){const f=h.index;f!==null&&d.version<f.version&&c(h)}else c(h);return r.get(h)}return{get:a,update:l,getWireframeAttribute:u}}function k0(i,e,t){let n;function s(d){n=d}let r,o;function a(d){r=d.type,o=d.bytesPerElement}function l(d,f){i.drawElements(n,f,r,d*o),t.update(f,n,1)}function c(d,f,g){g!==0&&(i.drawElementsInstanced(n,f,r,d*o,g),t.update(f,n,g))}function u(d,f,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,f,0,r,d,0,g);let m=0;for(let p=0;p<g;p++)m+=f[p];t.update(m,n,1)}function h(d,f,g,_){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let p=0;p<d.length;p++)c(d[p]/o,f[p],_[p]);else{m.multiDrawElementsInstancedWEBGL(n,f,0,r,d,0,_,0,g);let p=0;for(let x=0;x<g;x++)p+=f[x]*_[x];t.update(p,n,1)}}this.setMode=s,this.setIndex=a,this.render=l,this.renderInstances=c,this.renderMultiDraw=u,this.renderMultiDrawInstances=h}function z0(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,o,a){switch(t.calls++,o){case i.TRIANGLES:t.triangles+=a*(r/3);break;case i.LINES:t.lines+=a*(r/2);break;case i.LINE_STRIP:t.lines+=a*(r-1);break;case i.LINE_LOOP:t.lines+=a*r;break;case i.POINTS:t.points+=a*r;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function H0(i,e,t){const n=new WeakMap,s=new Qe;function r(o,a,l){const c=o.morphTargetInfluences,u=a.morphAttributes.position||a.morphAttributes.normal||a.morphAttributes.color,h=u!==void 0?u.length:0;let d=n.get(a);if(d===void 0||d.count!==h){let E=function(){w.dispose(),n.delete(a),a.removeEventListener("dispose",E)};d!==void 0&&d.texture.dispose();const f=a.morphAttributes.position!==void 0,g=a.morphAttributes.normal!==void 0,_=a.morphAttributes.color!==void 0,m=a.morphAttributes.position||[],p=a.morphAttributes.normal||[],x=a.morphAttributes.color||[];let S=0;f===!0&&(S=1),g===!0&&(S=2),_===!0&&(S=3);let v=a.attributes.position.count*S,L=1;v>e.maxTextureSize&&(L=Math.ceil(v/e.maxTextureSize),v=e.maxTextureSize);const A=new Float32Array(v*L*4*h),w=new Fd(A,v,L,h);w.type=bn,w.needsUpdate=!0;const C=S*4;for(let M=0;M<h;M++){const I=m[M],H=p[M],z=x[M],W=v*L*4*M;for(let K=0;K<I.count;K++){const X=K*C;f===!0&&(s.fromBufferAttribute(I,K),A[W+X+0]=s.x,A[W+X+1]=s.y,A[W+X+2]=s.z,A[W+X+3]=0),g===!0&&(s.fromBufferAttribute(H,K),A[W+X+4]=s.x,A[W+X+5]=s.y,A[W+X+6]=s.z,A[W+X+7]=0),_===!0&&(s.fromBufferAttribute(z,K),A[W+X+8]=s.x,A[W+X+9]=s.y,A[W+X+10]=s.z,A[W+X+11]=z.itemSize===4?s.w:1)}}d={count:h,texture:w,size:new ke(v,L)},n.set(a,d),a.addEventListener("dispose",E)}if(o.isInstancedMesh===!0&&o.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",o.morphTexture,t);else{let f=0;for(let _=0;_<c.length;_++)f+=c[_];const g=a.morphTargetsRelative?1:1-f;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function G0(i,e,t,n){let s=new WeakMap;function r(l){const c=n.render.frame,u=l.geometry,h=e.get(l,u);if(s.get(h)!==c&&(e.update(h),s.set(h,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;s.get(d)!==c&&(d.update(),s.set(d,c))}return h}function o(){s=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:o}}class Xd extends Tt{constructor(e,t,n,s,r,o,a,l,c,u=Ts){if(u!==Ts&&u!==Bs)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&u===Ts&&(n=qi),n===void 0&&u===Bs&&(n=Os),super(null,s,r,o,a,l,u,n,c),this.isDepthTexture=!0,this.image={width:e,height:t},this.magFilter=a!==void 0?a:Ht,this.minFilter=l!==void 0?l:Ht,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(e){return super.copy(e),this.compareFunction=e.compareFunction,this}toJSON(e){const t=super.toJSON(e);return this.compareFunction!==null&&(t.compareFunction=this.compareFunction),t}}const qd=new Tt,oh=new Xd(1,1),jd=new Fd,Yd=new Rm,$d=new Vd,ah=[],lh=[],ch=new Float32Array(16),uh=new Float32Array(9),hh=new Float32Array(4);function Ys(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=ah[s];if(r===void 0&&(r=new Float32Array(s),ah[s]=r),e!==0){n.toArray(r,0);for(let o=1,a=0;o!==e;++o)a+=t,i[o].toArray(r,a)}return r}function Mt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function St(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function fa(i,e){let t=lh[e];t===void 0&&(t=new Int32Array(e),lh[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function V0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function W0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Mt(t,e))return;i.uniform2fv(this.addr,e),St(t,e)}}function X0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Mt(t,e))return;i.uniform3fv(this.addr,e),St(t,e)}}function q0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Mt(t,e))return;i.uniform4fv(this.addr,e),St(t,e)}}function j0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Mt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),St(t,e)}else{if(Mt(t,n))return;hh.set(n),i.uniformMatrix2fv(this.addr,!1,hh),St(t,n)}}function Y0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Mt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),St(t,e)}else{if(Mt(t,n))return;uh.set(n),i.uniformMatrix3fv(this.addr,!1,uh),St(t,n)}}function $0(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Mt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),St(t,e)}else{if(Mt(t,n))return;ch.set(n),i.uniformMatrix4fv(this.addr,!1,ch),St(t,n)}}function K0(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function Z0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Mt(t,e))return;i.uniform2iv(this.addr,e),St(t,e)}}function J0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Mt(t,e))return;i.uniform3iv(this.addr,e),St(t,e)}}function Q0(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Mt(t,e))return;i.uniform4iv(this.addr,e),St(t,e)}}function ex(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function tx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Mt(t,e))return;i.uniform2uiv(this.addr,e),St(t,e)}}function nx(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Mt(t,e))return;i.uniform3uiv(this.addr,e),St(t,e)}}function ix(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Mt(t,e))return;i.uniform4uiv(this.addr,e),St(t,e)}}function sx(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(oh.compareFunction=Dd,r=oh):r=qd,t.setTexture2D(e||r,s)}function rx(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||Yd,s)}function ox(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||$d,s)}function ax(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||jd,s)}function lx(i){switch(i){case 5126:return V0;case 35664:return W0;case 35665:return X0;case 35666:return q0;case 35674:return j0;case 35675:return Y0;case 35676:return $0;case 5124:case 35670:return K0;case 35667:case 35671:return Z0;case 35668:case 35672:return J0;case 35669:case 35673:return Q0;case 5125:return ex;case 36294:return tx;case 36295:return nx;case 36296:return ix;case 35678:case 36198:case 36298:case 36306:case 35682:return sx;case 35679:case 36299:case 36307:return rx;case 35680:case 36300:case 36308:case 36293:return ox;case 36289:case 36303:case 36311:case 36292:return ax}}function cx(i,e){i.uniform1fv(this.addr,e)}function ux(i,e){const t=Ys(e,this.size,2);i.uniform2fv(this.addr,t)}function hx(i,e){const t=Ys(e,this.size,3);i.uniform3fv(this.addr,t)}function dx(i,e){const t=Ys(e,this.size,4);i.uniform4fv(this.addr,t)}function fx(i,e){const t=Ys(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function px(i,e){const t=Ys(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function mx(i,e){const t=Ys(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function gx(i,e){i.uniform1iv(this.addr,e)}function _x(i,e){i.uniform2iv(this.addr,e)}function xx(i,e){i.uniform3iv(this.addr,e)}function vx(i,e){i.uniform4iv(this.addr,e)}function yx(i,e){i.uniform1uiv(this.addr,e)}function Mx(i,e){i.uniform2uiv(this.addr,e)}function Sx(i,e){i.uniform3uiv(this.addr,e)}function bx(i,e){i.uniform4uiv(this.addr,e)}function Ex(i,e,t){const n=this.cache,s=e.length,r=fa(t,s);Mt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let o=0;o!==s;++o)t.setTexture2D(e[o]||qd,r[o])}function Tx(i,e,t){const n=this.cache,s=e.length,r=fa(t,s);Mt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let o=0;o!==s;++o)t.setTexture3D(e[o]||Yd,r[o])}function Ax(i,e,t){const n=this.cache,s=e.length,r=fa(t,s);Mt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let o=0;o!==s;++o)t.setTextureCube(e[o]||$d,r[o])}function wx(i,e,t){const n=this.cache,s=e.length,r=fa(t,s);Mt(n,r)||(i.uniform1iv(this.addr,r),St(n,r));for(let o=0;o!==s;++o)t.setTexture2DArray(e[o]||jd,r[o])}function Rx(i){switch(i){case 5126:return cx;case 35664:return ux;case 35665:return hx;case 35666:return dx;case 35674:return fx;case 35675:return px;case 35676:return mx;case 5124:case 35670:return gx;case 35667:case 35671:return _x;case 35668:case 35672:return xx;case 35669:case 35673:return vx;case 5125:return yx;case 36294:return Mx;case 36295:return Sx;case 36296:return bx;case 35678:case 36198:case 36298:case 36306:case 35682:return Ex;case 35679:case 36299:case 36307:return Tx;case 35680:case 36300:case 36308:case 36293:return Ax;case 36289:case 36303:case 36311:case 36292:return wx}}class Cx{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=lx(t.type)}}class Ix{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=Rx(t.type)}}class Lx{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,o=s.length;r!==o;++r){const a=s[r];a.setValue(e,t[a.id],n)}}}const Ja=/(\w+)(\])?(\[|\.)?/g;function dh(i,e){i.seq.push(e),i.map[e.id]=e}function Px(i,e,t){const n=i.name,s=n.length;for(Ja.lastIndex=0;;){const r=Ja.exec(n),o=Ja.lastIndex;let a=r[1];const l=r[2]==="]",c=r[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===s){dh(t,c===void 0?new Cx(a,i,e):new Ix(a,i,e));break}else{let h=t.map[a];h===void 0&&(h=new Lx(a),dh(t,h)),t=h}}}class ko{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let s=0;s<n;++s){const r=e.getActiveUniform(t,s),o=e.getUniformLocation(t,r.name);Px(r,o,this)}}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,o=t.length;r!==o;++r){const a=t[r],l=n[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const o=e[s];o.id in t&&n.push(o)}return n}}function fh(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const Dx=37297;let Nx=0;function Ux(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let o=s;o<r;o++){const a=o+1;n.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return n.join(`
`)}const ph=new Ue;function Fx(i){Xe._getMatrix(ph,Xe.workingColorSpace,i);const e=`mat3( ${ph.elements.map(t=>t.toFixed(4))} )`;switch(Xe.getTransfer(i)){case ca:return[e,"LinearTransferOETF"];case at:return[e,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function mh(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),s=i.getShaderInfoLog(e).trim();if(n&&s==="")return"";const r=/ERROR: 0:(\d+)/.exec(s);if(r){const o=parseInt(r[1]);return t.toUpperCase()+`

`+s+`

`+Ux(i.getShaderSource(e),o)}else return s}function Ox(i,e){const t=Fx(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}function Bx(i,e){let t;switch(e){case Np:t="Linear";break;case Up:t="Reinhard";break;case Fp:t="Cineon";break;case Op:t="ACESFilmic";break;case kp:t="AgX";break;case zp:t="Neutral";break;case Bp:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const vo=new R;function kx(){Xe.getLuminanceCoefficients(vo);const i=vo.x.toFixed(4),e=vo.y.toFixed(4),t=vo.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function zx(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(Mr).join(`
`)}function Hx(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function Gx(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),o=r.name;let a=1;r.type===i.FLOAT_MAT2&&(a=2),r.type===i.FLOAT_MAT3&&(a=3),r.type===i.FLOAT_MAT4&&(a=4),t[o]={type:r.type,location:i.getAttribLocation(e,o),locationSize:a}}return t}function Mr(i){return i!==""}function gh(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function _h(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const Vx=/^[ \t]*#include +<([\w\d./]+)>/gm;function tc(i){return i.replace(Vx,Xx)}const Wx=new Map;function Xx(i,e){let t=He[e];if(t===void 0){const n=Wx.get(e);if(n!==void 0)t=He[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return tc(t)}const qx=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function xh(i){return i.replace(qx,jx)}function jx(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function vh(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}function Yx(i){let e="SHADOWMAP_TYPE_BASIC";return i.shadowMapType===yd?e="SHADOWMAP_TYPE_PCF":i.shadowMapType===fp?e="SHADOWMAP_TYPE_PCF_SOFT":i.shadowMapType===jn&&(e="SHADOWMAP_TYPE_VSM"),e}function $x(i){let e="ENVMAP_TYPE_CUBE";if(i.envMap)switch(i.envMapMode){case Ns:case Us:e="ENVMAP_TYPE_CUBE";break;case la:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Kx(i){let e="ENVMAP_MODE_REFLECTION";if(i.envMap)switch(i.envMapMode){case Us:e="ENVMAP_MODE_REFRACTION";break}return e}function Zx(i){let e="ENVMAP_BLENDING_NONE";if(i.envMap)switch(i.combine){case Lc:e="ENVMAP_BLENDING_MULTIPLY";break;case Pp:e="ENVMAP_BLENDING_MIX";break;case Dp:e="ENVMAP_BLENDING_ADD";break}return e}function Jx(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Qx(i,e,t,n){const s=i.getContext(),r=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=Yx(t),c=$x(t),u=Kx(t),h=Zx(t),d=Jx(t),f=zx(t),g=Hx(r),_=s.createProgram();let m,p,x=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
    ...
    <div class="perf-overlay"></div>`,De.vignette=yt.querySelector(".vignette"),De.hpBar=yt.querySelector(".bar.hp"),De.hpFill=yt.querySelector(".bar.hp .bar-fill"),De.hpGhost=yt.querySelector(".bar.hp .bar-ghost"),De.hpText=yt.querySelector(".bar.hp .bar-text"),De.xpTop=yt.querySelector(".xp-top"),De.xpFill=yt.querySelector(".xp-top-fill"),De.level=yt.querySelector(".level-badge"),De.timer=yt.querySelector(".hud-timer"),De.banner=yt.querySelector(".climax-banner"),De.embers=yt.querySelector(".stat.embers .stat-val"),De.kills=yt.querySelector(".stat.kills .stat-val"),Te.on("run-start",()=>{Ir=0,xi=1,gs=1,Tr=0,yt.classList.add("visible"),yt.classList.remove("climax"),De.banner.classList.remove("show")}),Te.on("game-over",()=>{yt.classList.remove("visible","climax")}),Te.on("player-hit",()=>{Ir=1,De.hpBar.classList.remove("shake"),De.hpBar.offsetWidth,De.hpBar.classList.add("shake")}),Te.on("level-up",()=>{De.xpTop.classList.remove("burst"),De.level.classList.remove("pop"),De.xpTop.offsetWidth,De.xpTop.classList.add("burst"),De.level.classList.add("pop")}),De.perf=yt.querySelector(".perf-overlay"),window.addEventListener("keydown",i=>{i.code==="F3"&&(i.preventDefault(),Xo=!Xo,De.perf.classList.toggle("show",Xo))}),Te.on("climax-start",({label:i})=>{yt.classList.add("climax"),De.banner.textContent=i,De.banner.classList.add("show"),setTimeout(()=>De.banner.classList.remove("show"),4e3)})}function db(i){if(!yt)return;if(Xo&&(fl+=i,fl>=.5)){fl=0;const h=window.__perf??{frames:0,workMs:0},d=performance.now(),f=h.frames-Lo.frames,g=h.workMs-Lo.workMs,_=(d-Lo.t)/1e3,m=_>0?Math.round(f/_):0,p=f>0?(g/f).toFixed(2):"—";Lo={frames:h.frames,workMs:h.workMs,t:d};const x=oi.info;De.perf.textContent=`${m} fps · ${p} ms cpu
${x.render.calls} draws · ${(x.render.triangles/1e3).toFixed(0)}k tris
${Ki().length} enemies · dpr ${oi.getPixelRatio()}
v${ge.version}`}Ir=Math.max(0,Ir-i*2.2);const e=F.player.maxHp>0?F.player.hp/F.player.maxHp:0,t=e<.35?(.35-e)/.35*.45:0;De.vignette.style.opacity=Math.min(1,Ir*.9+t).toFixed(3);const n=Math.max(0,Math.min(1,e));De.hpFill.style.width=`${n*100}%`,n<gs-.001?(Io=.35,xi<gs&&(xi=gs)):n>gs+.001&&(Tr=.4,xi=n),gs=n,Io=Math.max(0,Io-i),Io<=0&&xi>n&&(xi=Math.max(n,xi-i*.6)),De.hpGhost.style.width=`${xi*100}%`,Tr=Math.max(0,Tr-i),De.hpBar.classList.toggle("heal",Tr>0),De.hpBar.classList.toggle("low",n<.35&&F.running);const s=`${Math.max(0,Math.ceil(F.player.hp))} / ${Math.round(F.player.maxHp)}`;s!==sn.hpText&&(sn.hpText=s,De.hpText.textContent=s);const r=F.xpNext>0?F.xp/F.xpNext:0;r>fd+5e-4&&Co<=0&&(Co=.16,De.xpFill.classList.remove("pulse"),De.xpFill.offsetWidth,De.xpFill.classList.add("pulse")),fd=r,Co=Math.max(0,Co-i),De.xpFill.style.width=`${Math.max(0,Math.min(1,r))*100}%`,De.xpTop.classList.toggle("near",r>.85),F.level!==sn.level&&(sn.level=F.level,De.level.textContent=`Lvl ${F.level}`);const o=Number.isFinite(ge.run.duration)?Math.max(0,ge.run.duration-F.time):F.time,a=Math.floor(o/60),l=Math.floor(o%60),c=`${a}:${String(l).padStart(2,"0")}`;c!==sn.timer&&(sn.timer=c,De.timer.textContent=c);const u=Number.isFinite(ge.run.duration)&&o<=30&&F.running;u!==sn.urgent&&(sn.urgent=u,De.timer.classList.toggle("urgent",u)),F.gold!==sn.embers&&(sn.embers=F.gold,De.embers.textContent=F.gold),F.kills!==sn.kills&&(sn.kills=F.kills,De.kills.textContent=F.kills)}const fb=Object.freeze(Object.defineProperty({__proto__:null,init:hb,update:db},Symbol.toStringTag,{value:"Module"}));let Ls=null,Ec=[],Tc=[],Lr=null;const Rt=i=>Te.emit("sfx",{name:i}),pd=ue.spinIcons,Ie=ue.strings;function qo(i,e){Ec.push(setTimeout(i,e))}function md(i,e){const t=setInterval(i,e);return Tc.push(t),t}function tp(){for(const i of Ec)clearTimeout(i);for(const i of Tc)clearInterval(i);Ec=[],Tc=[]}function ne(i,e,t){const n=document.createElement(i);return e&&(n.className=e),t!=null&&(n.textContent=t),n}function Kr(i){tp(),Ls.innerHTML="";const e=ne("div",`modal ${i||""}`.trim());return Ls.appendChild(e),Ls.classList.add("active"),e}function Ea(){tp(),Lr&&(window.removeEventListener("keydown",Lr),Lr=null),Ls.classList.remove("active"),Ls.innerHTML=""}function gd(i,e){i.classList.remove("shake-1","shake-2","shake-3"),i.offsetWidth,i.classList.add(`shake-${Math.max(1,Math.min(3,e))}`)}function pb(){Ls=document.getElementById("overlay"),Te.on("levelup-choices",_b),Te.on("chest-opened",xb),Te.on("game-over",sp),gb()}function mb(i){}function np(){const i=ne("div","jobs-wrap");i.appendChild(ne("div","jobs-label",Ie.crewLabel));const e=ne("div","crew-row"),t=ne("p","job-blurb"),n=ne("div","crew-balance"),s=()=>{e.innerHTML="";const r=qs();for(const a of kr){const l=ga(a.id)||!a.cost,c=ne("button",`crew-chip${l?"":" locked"}${r.id===a.id?" selected":""}`,l?a.name:`${a.name} · ${a.cost} ${Ie.currencyIcon}`);c.addEventListener("click",()=>{l?(Mf(a.id),Rt("click")):Sf(a.id,a.cost)?Rt("buy"):Rt("hit"),s()}),e.appendChild(c)}const o=qs();t.textContent=`${o.name} — ${o.desc}`,n.textContent=Ie.shopBalance(na())};return s(),i.append(e,t,n),i}function ip(){if(Ti.length<=1)return null;const i=ne("div","jobs-wrap");i.appendChild(ne("div","jobs-label",Ie.contractsLabel));const e=ne("div","jobs-row"),t=ne("p","job-blurb"),n=()=>{e.innerHTML="",Ti.forEach((r,o)=>{const a=o<Br(),l=o>Br(),c=ne("button",`job-chip${a?" done":""}${l?" locked":""}${o===Un?" selected":""}`,a?Ie.sealIcon:String(o+1));c.title=l?Ie.lockedLabel:r.name,c.disabled=l,c.addEventListener("click",()=>{Rt("click"),uu(o),n()}),e.appendChild(c)});const s=Ti[Un];t.textContent=`${s.name} — ${s.blurb}${(s.payMult??1)>1?` · pays ×${s.payMult}`:""}`};if(n(),i.append(e,t),lu()){const s=ne("label","endless-toggle"),r=ne("input");r.type="checkbox",r.checked=ii,r.addEventListener("change",()=>{Rt("click"),Af(r.checked)}),s.appendChild(r),s.appendChild(ne("span",null,Ie.endlessLabel)),i.appendChild(s)}return i}function gb(){const i=Kr("start");i.appendChild(ne("div","sigil-mark",Ie.startMark)),i.appendChild(ne("h1",null,Ie.startTitle)),i.appendChild(ne("p","sub",Ie.startTagline));const e=ne("div","contract-paper");for(const c of Ie.contractClauses){const u=ne("p");u.append(ne("span","clause-no",c.lead),document.createTextNode(c.text)),e.appendChild(u)}e.appendChild(ne("span","signature",Ie.signature)),i.appendChild(e);const t=ne("button","btn btn-blood",Ie.signButton);t.addEventListener("click",()=>{Rt("click"),Ea(),Te.emit("restart-run",{})}),i.appendChild(t);const n="ontouchstart"in window||navigator.maxTouchPoints>0;i.appendChild(ne("p","hint",n?Ie.hintTouch:Ie.hint)),kr.length>1&&i.appendChild(np());const s=ip();s&&i.appendChild(s);const r=ne("div","theme-row");r.appendChild(ne("span","theme-label",Ie.gfxLabel));const o=ne("div","crew-row"),a=()=>{o.innerHTML="";for(const c of Object.keys(js)){const u=ne("button",`crew-chip${yS()===c?" selected":""}`,js[c].label);u.addEventListener("click",()=>{Rt("click"),SS(c),a()}),o.appendChild(u)}};a(),r.appendChild(o),i.appendChild(r);const l=_S();if(l>0){const c=ne("button","telemetry-btn",`⇣ playtest data · ${l} run${l===1?"":"s"}`);c.title="Download your local run stats as JSON (nothing is sent automatically)",c.addEventListener("click",()=>{Rt("click"),xS()}),i.appendChild(c)}}function _b({choices:i,onPick:e}){const t=Kr("levelup");t.appendChild(ne("h2",null,Ie.levelupTitle)),t.appendChild(ne("p","sub",Ie.levelupSub));const n=ne("div","cards"),s=r=>{Rt("click"),Ea(),e(r)};Lr=r=>{const o=["Digit1","Digit2","Digit3"].indexOf(r.code);o>=0&&i[o]&&s(i[o])},window.addEventListener("keydown",Lr),i.forEach((r,o)=>{const a=ne("div","card");a.appendChild(ne("span","card-key",String(o+1))),a.appendChild(ne("div","card-icon",r.icon)),a.appendChild(ne("div","card-name",r.name)),a.appendChild(ne("div","card-desc",r.desc)),a.addEventListener("click",()=>s(r)),n.appendChild(a)}),t.appendChild(n)}function xb({rewards:i,gold:e,onDone:t}){const n=Kr("chest-modal"),s=i.length,r=s>=5?2:s>=3?1:0;n.appendChild(ne("h2",null,Ie.chestTitle)),n.appendChild(ne("p","sub",r===2?Ie.chestSub[5]:r===1?Ie.chestSub[3]:Ie.chestSub[1]));const o=r?n.appendChild(ne("div","jackpot-banner",r===2?Ie.jackpotBanner[5]:Ie.jackpotBanner[3])):null;o&&(o.style.visibility="hidden");const a=ne("div","slots"),l=i.map(_=>{const m=ne("div","slot");return m.appendChild(ne("div","slot-icon","?")),m.appendChild(ne("div","slot-name",_.name)),a.appendChild(m),m});n.appendChild(a);const c=ne("div","gold-line",Ie.goldLabel),u=ne("span","gold-count","0");c.appendChild(u),n.appendChild(c);const h=ne("button","btn",Ie.collectButton);h.disabled=!0,h.addEventListener("click",()=>{h.disabled||(Rt("click"),Ea(),t())}),n.appendChild(h),Rt("jingle");const d=600,f=260;i.forEach((_,m)=>{const p=l[m],x=p.querySelector(".slot-icon"),S=350+m*(d+f);qo(()=>{p.classList.add("spinning");const v=md(()=>{x.textContent=pd[Math.random()*pd.length|0]},55);qo(()=>{clearInterval(v),p.classList.remove("spinning"),p.classList.add("landed"),x.textContent=_.icon,Rt("chest"),gd(n,1+r*(m>=s-2?1:0)+(m===s-1&&r===2?1:0)),m===s-1&&(r===1&&n.classList.add("jackpot"),r===2&&n.classList.add("jackpot","jackpot-big"),o&&(o.style.visibility="visible"))},d)},S)});const g=350+s*(d+f);qo(()=>{u.classList.add("ticking");const _=70,m=Math.min(1600,Math.max(700,e*45)),p=Math.max(1,Math.round(m/_));let x=0;const S=md(()=>{x++;const v=x/p,L=1-(1-v)*(1-v);u.textContent=String(Math.round(e*Math.min(1,L))),x%2===1&&Rt("coin"),x>=p&&(clearInterval(S),u.textContent=String(e),u.classList.remove("ticking"),gd(n,1+r),h.disabled=!1,h.classList.add("ready"))},_)},g+250)}function sp(i){if(i.finale&&!i._creditsShown){vb(i);return}const{victory:e,embers:t,kills:n,time:s,level:r}=i,o=Kr("gameover"),a=ne("h1",e?"":"defeat",e?Ie.victoryTitle:Ie.defeatTitle);o.appendChild(a),o.appendChild(ne("p","sub",e?Ie.victorySub:Ie.defeatSub));const l=ne("div","stats-row"),c=Math.floor(s/60),u=Math.floor(s%60),h=[[Ie.statKills,String(n)],[Ie.statTime,`${c}:${String(u).padStart(2,"0")}`],[Ie.statLevel,String(r)]];for(const[_,m]of h){const p=ne("div","stat-block");p.appendChild(ne("span","stat-label",_)),p.appendChild(ne("span","stat-value",m)),l.appendChild(p)}o.appendChild(l),o.appendChild(ne("div","embers-banked",Ie.banked(t)));for(const _ of i.earnedPosters??[])o.appendChild(ne("div","poster-claimed",Ie.posterClaimed(_.name,_.bounty)));o.appendChild(ne("hr","rule"));const d=ne("div","shop");if(o.appendChild(d),rp(d),vc.length){const _=ne("div","poster-wall");_.appendChild(ne("h3",null,Ie.postersTitle));for(const m of vc){const p=au(m.id),x=ne("div",`poster-row${p?" got":""}`);x.appendChild(ne("span","poster-name",m.name)),x.appendChild(ne("span","poster-desc",m.desc)),x.appendChild(ne("span","poster-bounty",p?"✓":`+${m.bounty} ${Ie.currencyIcon}`)),_.appendChild(x)}o.appendChild(_)}i.finale&&o.appendChild(ne("div","endless-note",Ie.endlessUnlockedNote)),kr.length>1&&o.appendChild(np());const f=ip();f&&o.appendChild(f);const g=ne("button","btn btn-blood",Ie.newRunButton);g.addEventListener("click",()=>{Rt("click"),Ea(),Te.emit("restart-run",{})}),o.appendChild(g)}function vb(i){const e=Kr("credits");e.appendChild(ne("h1",null,Ie.creditsTitle));const t=ne("div","credits-roll");Ie.creditsLines.forEach((s,r)=>{const o=ne("p","credits-line",s);o.style.animationDelay=`${.6+r*.9}s`,t.appendChild(o)}),e.appendChild(t),Rt("victory");const n=ne("button","btn",Ie.creditsButton);n.addEventListener("click",()=>{Rt("click"),sp({...i,_creditsShown:!0})}),qo(()=>e.appendChild(n),1200)}function rp(i){i.innerHTML="";const e=ne("div","shop-head");e.appendChild(ne("h3",null,Ie.shopTitle)),e.appendChild(ne("span","shop-embers",Ie.shopBalance(na()))),i.appendChild(e);const t=ne("div","pact-list"),n=na();for(const[s,r]of Object.entries(Ri)){const o=er(s),a=o>=r.maxLevel,l=cu(s),c=ne("div","pact-row");c.appendChild(ne("div","pact-icon",r.icon));const u=ne("div","pact-info");u.appendChild(ne("div","pact-name",r.name)),u.appendChild(ne("div","pact-effect",r.effect)),c.appendChild(u);const h=ne("div","pact-pips");for(let f=0;f<r.maxLevel;f++)h.appendChild(ne("span",f<o?"pip":"pip-empty","⬥"));c.appendChild(h);const d=ne("button",`btn pact-buy${a?" sealed":""}`,a?Ie.maxedLabel:Ie.buyLabel(l));d.disabled=a||n<l,d.addEventListener("click",()=>{Ef(s)&&(Rt("buy"),rp(i))}),c.appendChild(d),t.appendChild(c)}i.appendChild(t)}const yb=Object.freeze(Object.defineProperty({__proto__:null,init:pb,update:mb},Symbol.toStringTag,{value:"Module"}));let wt=null,Ps=null,Po=null,kt=null,Ac=!1;const _d={},Mb=45;let pl=0,xd=-1e9;function Sb(){window.addEventListener("pointerdown",bb,{passive:!0}),Te.on("sfx",e=>xr(e&&e.name)),Te.on("level-up",()=>xr("levelup")),Te.on("enemy-killed",()=>xr("kill")),Te.on("gold-gained",()=>xr("coin")),Te.on("player-hit",()=>xr("hit"));const i=ue.assets?.audio?.music?.run;i&&(kt=new Audio(typeof i=="string"?i:i.url),kt.loop=!0,kt.volume=typeof i=="object"&&i.volume||.35,kt.preload="auto",Te.on("run-start",()=>{Ac=!0,kt.currentTime=0,kt.play().catch(()=>{})}),Te.on("game-over",()=>{Ac=!1;const e=kt.volume,t=setInterval(()=>{kt.volume=Math.max(0,kt.volume-e/10),kt.volume<=.01&&(clearInterval(t),kt.pause(),kt.volume=e)},60)}))}function bb(){try{if(!wt){const i=window.AudioContext||window.webkitAudioContext;if(!i)return;wt=new i,Ps=wt.createGain(),Ps.gain.value=.25,Ps.connect(wt.destination)}wt.state==="suspended"&&wt.resume(),kt&&Ac&&kt.paused&&kt.play().catch(()=>{})}catch{}}function xr(i){if(!wt||!Ps||!vd[i])return;const e=performance.now();if(!(e-(_d[i]||-1e9)<Mb)){_d[i]=e;try{vd[i]()}catch{}}}function ot({f:i=440,f2:e=0,type:t="sine",at:n=0,dur:s=.15,vol:r=.3,attack:o=.008}){const a=wt.currentTime+n,l=wt.createOscillator(),c=wt.createGain();l.type=t,l.frequency.setValueAtTime(i,a),e>0&&l.frequency.exponentialRampToValueAtTime(e,a+s),c.gain.setValueAtTime(1e-4,a),c.gain.linearRampToValueAtTime(r,a+o),c.gain.exponentialRampToValueAtTime(1e-4,a+s),l.connect(c),c.connect(Ps),l.start(a),l.stop(a+s+.03)}function ml({at:i=0,dur:e=.12,vol:t=.3,freq:n=900,q:s=1,type:r="bandpass"}){if(!Po){Po=wt.createBuffer(1,wt.sampleRate*.5,wt.sampleRate);const u=Po.getChannelData(0);for(let h=0;h<u.length;h++)u[h]=Math.random()*2-1}const o=wt.currentTime+i,a=wt.createBufferSource();a.buffer=Po,a.loop=!0;const l=wt.createBiquadFilter();l.type=r,l.frequency.setValueAtTime(n,o),l.Q.value=s;const c=wt.createGain();c.gain.setValueAtTime(1e-4,o),c.gain.linearRampToValueAtTime(t,o+.005),c.gain.exponentialRampToValueAtTime(1e-4,o+e),a.connect(l),l.connect(c),c.connect(Ps),a.start(o),a.stop(o+e+.03)}const vd={shoot(){ot({f:660,f2:160,type:"sawtooth",dur:.07,vol:.12})},hit(){ot({f:140,f2:55,type:"square",dur:.16,vol:.3}),ml({dur:.1,vol:.22,freq:350,type:"lowpass"})},kill(){ot({f:330,f2:90,type:"square",dur:.09,vol:.16}),ml({dur:.05,vol:.1,freq:1800,q:2})},pickup(){ot({f:780,f2:1240,type:"sine",dur:.08,vol:.14})},coin(){const i=performance.now();pl=i-xd<300?Math.min(pl+1,14):0,xd=i;const e=988*Math.pow(2,pl/12);ot({f:e,type:"triangle",dur:.11,vol:.2}),ot({f:e*1.5,type:"sine",dur:.09,vol:.1,at:.012})},levelup(){ot({f:392,type:"triangle",dur:.22,vol:.22}),ot({f:494,type:"triangle",dur:.22,vol:.22,at:.1}),ot({f:587,type:"triangle",dur:.34,vol:.24,at:.2}),ot({f:784,type:"sine",dur:.4,vol:.14,at:.2})},chest(){ot({f:196,type:"triangle",dur:.3,vol:.2}),ot({f:294,type:"triangle",dur:.3,vol:.16,at:.01}),ot({f:392,type:"sine",dur:.34,vol:.14,at:.02})},jingle(){const i=[523,659,784,1046,1318];i.forEach((e,t)=>{ot({f:e,type:"triangle",dur:.18,vol:.2,at:t*.075}),ot({f:e*2,type:"sine",dur:.14,vol:.06,at:t*.075})}),ot({f:1568,type:"sine",dur:.45,vol:.12,at:i.length*.075}),ot({f:2093,type:"sine",dur:.5,vol:.08,at:i.length*.075+.03})},death(){ot({f:220,f2:38,type:"sawtooth",dur:.9,vol:.26}),ot({f:110,f2:30,type:"triangle",dur:1.1,vol:.22,at:.05}),ml({dur:.7,vol:.12,freq:200,type:"lowpass"})},victory(){const i=[[392,0],[523,.14],[659,.28],[784,.42]];for(const[e,t]of i)ot({f:e,type:"triangle",dur:.26,vol:.22,at:t}),ot({f:e/2,type:"sine",dur:.26,vol:.1,at:t});ot({f:1046,type:"triangle",dur:.7,vol:.24,at:.56}),ot({f:784,type:"sine",dur:.7,vol:.12,at:.56}),ot({f:1318,type:"sine",dur:.6,vol:.08,at:.62})},buy(){ot({f:190,type:"square",dur:.05,vol:.16}),ot({f:1175,type:"triangle",dur:.14,vol:.18,at:.06}),ot({f:1760,type:"sine",dur:.18,vol:.1,at:.09})},click(){ot({f:1100,f2:700,type:"square",dur:.035,vol:.1})}};await hM(ue);const gu=[CM,kM,LS,ub,GS,uS,KS,nb],op=[fb,yb];by();bS();_f();gS();SM();uu(Math.min(Br(),Ti.length-1));Sb();for(const i of gu)i.init(qt);for(const i of op)i.init();function Eb(){wy(),wf(),Ty(Xs().world),bM(F),Tf(F);for(const i of gu)i.reset();F.running=!0,Te.emit("run-start",{})}Te.on("restart-run",Eb);let wc=!1;Te.on("run-start",()=>{wc=!1});function _u(i){if(wc)return;wc=!0,F.running=!1;const e=F.kills*.03*F.mods.greed,t=Xs().payMult??1,n=Math.round((F.gold+e)*(i?1.5:1)*t);xf(n);const s=i&&lc()&&!ii;i&&!ii&&bf(Un,lc());const r=vS({victory:i,job:Un+1,endless:ii,time:F.time,level:F.level,kills:F.kills,goldRun:F.gold,embersBanked:n,...F.runFlags});Te.emit("game-over",{victory:i,finale:s,embers:n,kills:F.kills,time:F.time,level:F.level,earnedPosters:r})}Te.on("player-died",()=>_u(!1));Te.on("climax-victory",()=>_u(!0));window.__mephisto={state:F,bus:Te,config:ge,contracts:vM,meta:xM,renderer:oi};const Rc={last:performance.now()},Cc={frames:0,workMs:0};window.__perf=Cc;function ap(i){requestAnimationFrame(ap);const e=i-Rc.last;if(e<MS())return;let t=Math.min(e/1e3,.05);Rc.last=i;const n=performance.now();if(F.running&&!F.paused){F.time+=t,F.time>=ge.run.duration&&!ep()&&_u(!0);for(const s of gu)s.update(t)}for(const s of op)s.update(t);Ay(F.player.pos),oi.render(qt,Sn),Cc.frames++,Cc.workMs+=performance.now()-n}requestAnimationFrame(i=>{Rc.last=i,ap(i)});
